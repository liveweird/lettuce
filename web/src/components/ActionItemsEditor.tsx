...
/**
 * The action-items editor of the 1:1 form — its own `Fieldset` section (v3.5.0): each row is
 * a paragraph plus an owner (one of the meeting's two parties), an optional due date, and a
 * resolved checkbox. Rows carried over from the previous meeting (copiedFromId set) get a
 * badge and a history button opening the cross-meeting timeline of that item.
 */
