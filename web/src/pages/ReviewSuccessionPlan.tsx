    ...
    <MetaStrip
      items={[
        ...
        },
        {
          ...
          value:
            currentUserId === plan.managerId ? (
              you
            ) : (
              <PersonaChip name={plan.managerName} />
            ),
        },
        {
          key: "lastReviewed",
          ...
          value: (
            <Text
              size="sm"
              title={formatDateTime(plan.lastReviewedAt, i18n.language)}
            >
...
export default function ReviewSuccessionPlan() {
  ...
  const hereUrl = idIsValid
    ? successionPlanViewLink(id, backOverride ?? undefined)
    : "/succession";

  const [closePlanOpen, { open: openClosePlan, close: closeClosePlan }] =
    useDisclosure(false);
  ...
  const isOwner =
    data != null && currentUserId != null && currentUserId === data.managerId;
  ...
  const liveTarget =
    canEdit &&
    Number.isFinite(Number(form.values.targetBenchDepth)) &&
    Number(form.values.targetBenchDepth) > 0
  ...
  return (
    <>
                ...
                <Tabs defaultValue="basics" keepMounted={false}>
                  <Tabs.List>
                    <Tabs.Tab value="basics">
                      {t("succession.tab.basics")}
                    </Tabs.Tab>
                    <Tabs.Tab value="nominations">
                      {t("succession.tab.nominations")}
                    </Tabs.Tab>
                    <Tabs.Tab value="history">
                      {t("succession.tab.history")}
                    </Tabs.Tab>
                  </Tabs.List>
                  ...
                  <Tabs.Panel value="basics" pt="md">
                    <Stack>
                      ...
                      {canEdit ? (
                        ...
                        // view below (SuccessionPlanFields owns them since v3.12.1).
                            ...
                            <Stack gap="sm">
                              <Group justify="space-between" align="flex-start">
                                ...
                                {canEdit && (
                                  <Group gap="xs">
                                    <Button
                                      component={RouterLink}
                                      to={successionNominationEditLink(
                                        id,
                                        nomination.id,
                                        hereUrl,
                                      )}
                                    ...
                                    <Button
                                      ...
                                      aria-label={t(
                                        "succession.deleteNominationAria",
                                        {
                                          name: nomination.candidateName,
                                        },
                                      )}
                                      onClick={() =>
                                        nominationDelete.requestDelete(
                                          nomination,
                                        )
                                      }
                                    >
                              ...
                              <Group gap="xl">
                                ...
                                >
                                  <Text size="sm">
                                    {t(
                                      `succession.readiness.${nomination.readiness}`,
                                    )}
                                  </Text>
                                </ReadOnlyField>
                                <ReadOnlyField
                                ...
                                >
                                  <Text size="sm">
                                    {t(
                                      `succession.nominationType.${nomination.nominationType}`,
                                    )}
                                  </Text>
                                </ReadOnlyField>
                                <ReadOnlyField
                                ...
                                >
                                  <Text size="sm">
                                    {t(
                                      `succession.awareness.${nomination.awareness}`,
                                    )}
                                  </Text>
                                </ReadOnlyField>
                              </Group>
                                      ...
                                      (gap, index) => (
                                        <List.Item key={index}>
                                          ...
                                          <Text
                                            ...
                                            size="sm"
                                            c={
                                              gap.filled ? "dimmed" : undefined
                                            }
                                            style={{
                                              textDecoration: gap.filled
                                                ? "line-through"
                                                : undefined,
                                            }}
                                          >
      ...
      <ConfirmDeleteModal
        ...
        body={(target) =>
          t("succession.deleteNominationConfirmMessage", {
