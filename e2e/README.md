...
- [`goals-tutorial.spec.ts`](scenarios/goals-tutorial.md) — the "How goals work" guided tutorial (v3.15.0): the manager's 12-step and the non-manager's 6-step read-only walk, landmark order, and the return to the Goals page with own/managed goal totals unchanged.
