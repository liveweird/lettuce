...
// The guided tour, actually walked: replay it as a manager (the widest audience — 30 steps)
...
test("the guided tour walks all 30 manager steps in the documented order", async ({ page }) => {
