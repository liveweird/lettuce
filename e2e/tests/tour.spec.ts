...
// The guided tour, actually walked: replay it as a manager (the widest audience — 26 steps)
...
test("the guided tour walks all 26 manager steps in the documented order", async ({ page }) => {
