...
6. They open the **History** tab.
   - *Expected*: the plan's audit trail renders newest-first, localized — the creation entry
     ("Plan created (Critical / High, bench target 2)."), each nomination's addition, and the
