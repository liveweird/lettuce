...
- **Polish voice/gender convention:** masculine-default, **active/direct** voice, same tense and meaning as the English — e.g. `"Poprosiłeś {{provider}} o feedback…"`, `"{{provider}} odmówił…"`. Do **not** use impersonal/passive forms (`"Poproszono…"`, `"Wylogowano Cię"`) or `(a)` suffixes.
