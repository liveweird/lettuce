 ...
 * [lettuceTestClientDefaults], i.e. in every `jsonClient()`/`authedClient()`) validates each
 ...
 * Installed once per test client via [lettuceTestClientDefaults]. Throws [AssertionError] from
