 ...
 * `XPageResponse` is a typealias over this (see e.g. `users/User.kt`), so the JSON wire shape and
 * the OpenAPI `*Page` schemas stay identical while the Kotlin type is defined once.
 */
@Serializable
