 ...
 * in the RECIPIENT'S language (v2.21.0 — previously bilingual EN then PL). Side-effect-free
 * and directly unit-tested (LocalizedEmailTest); the feature-specific wrappers
