 ...
 * password-reset endpoint) treat null as "email features unavailable" and answer 503.
 */
 ...
 * [MailerKey]. Registered in application.yaml before configureAuthRoutes (which consumes it).
 *
 * Transports:
 ...
 *    transport at startup (same fail-closed family as the JWT-secret and encryption-key checks).
