...
/**
 * Content of the password-reset email, rendered in the recipient's language (v2.21.0).
 * Thin wrapper over the shared scaffold (infra/mail/PasswordEmail.kt) — only the intro copy,
 * the password label, and the subject live here.
 */
internal val PASSWORD_RESET_EMAIL_SUBJECT: LocalizedText = LocalizedText(
    en = "Your new Lettuce password",
    pl = "Twoje nowe hasło Lettuce",
)

private val INTRO = LocalizedText(
    en = "a password reset was requested for your Lettuce account, so your previous " +
    ...
    pl = "ktoś poprosił o zresetowanie hasła do Twojego konta Lettuce, więc Twoje " +
