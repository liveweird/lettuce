...
/**
 * The MFA branch of POST /api/v1/login (v2.4.0): credentials verified, second factor pending —
 * no tokens yet. The client sends the emailed 6-digit code with [challengeId] to
