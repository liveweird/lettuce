-- Diacritics-insensitive substring filters (v1.47.0). Every list-endpoint text filter now
-- renders public.unaccent(LOWER(col)) LIKE public.unaccent(<pattern>) (see the shared
